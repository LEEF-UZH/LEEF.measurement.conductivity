...
#'
#' @param input The folder, where a folder \code{conductivity} is located which
#'   contains the new files.
#' @param output A folder, which contains a subfolder called \code{conductivity}, i.e.
...
#'   are in the error files in the \code{input/conductivity} directory.
